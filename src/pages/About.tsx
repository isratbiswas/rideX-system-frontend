    ...
    <SectionWrapper>
      <section className="py-16 px-6 md:px-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 ">
          ...
          <div className="mt-14">
            <h2 className="text-3xl font-bold text-center text-[#DE802B] mb-4 mt-6">
              About RideX
            </h2>
        ...
        {/* Mission & Vision */}
        <div className="grid md:grid-cols-2 gap-10 mb-14 text-left lg:mt-20">
          <div className="p-6 bg-white dark:bg-gray-800 rounded-2xl border-1 border-[#5C6F2B] shadow">
            <h3 className="text-xl font-semibold text-[#DE802B] mb-3">
              Our Mission
            </h3>
        ...
        {/* Core Values */}
        <h3 className="text-2xl font-bold text-gray-500 dark:text-white mb-8 lg:mt-20">
          Our Core Values
        </h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-14">
          <div className="flex flex-col items-center p-4 bg-white dark:bg-gray-800 border-1 rounded-2xl shadow">
            <FaShieldAlt className="text-4xl text-[#DE802B] mb-3" />
          ...
          <div className="flex flex-col border-1  items-center p-4 bg-white dark:bg-gray-800 rounded-2xl shadow">
            <FaClock className="text-4xl text-[#DE802B] mb-3" />
            <h4 className="font-semibold text-gray-800 dark:text-white">
              Reliability
            </h4>
            <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
          ...
          <div className="flex flex-col border-1  items-center p-4 bg-white dark:bg-gray-800 rounded-2xl shadow">
            <FaMoneyBillWave className="text-4xl text-[#DE802B] mb-3" />
            <h4 className="font-semibold text-gray-800 dark:text-white">
              Affordability
            </h4>
            <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
          ...
          <div className="flex flex-col border-1  items-center p-4 bg-white dark:bg-gray-800 rounded-2xl shadow">
            <FaCarSide className="text-4xl text-[#DE802B] mb-3" />
            <h4 className="font-semibold text-gray-800 dark:text-white">
              Innovation
            </h4>
            <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
        ...
        <div>
          <h2 className="text-2xl font-bold text-center text-gray-500 mb-12 lg:mt-20">
            Meet Our Team
          </h2>
          <div className="grid lg:grid-cols-3  md:grid-cols-3  sm:grid-cols-1 gap-4">
            {teams.map((team, ind) => (
              ...
              >
                ...
                <h2 className="font-bold text-lg text-gray-700 dark:text-gray-800 mt-2 ">
                  {team.name}
                </h2>
                <h4 className="text-primary font-semibold text-gray-800 dark:text-gray-800 mt-2 ">
                  {team.role}
                </h4>
                <p className="text-gray-800 mt-2">{team.desc}</p>
              </div>
            ))}
          </div>
        </div>
